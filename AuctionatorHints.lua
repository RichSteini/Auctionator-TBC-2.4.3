...
function Atr_SetMFcolor (frameName, blue)
	...
	if (blue) then
		goldButton:SetTextFontObject(NumberFontNormalRightATRblue);
		silverButton:SetTextFontObject(NumberFontNormalRightATRblue);
		copperButton:SetTextFontObject(NumberFontNormalRightATRblue);
	else
		goldButton:SetTextFontObject(NumberFontNormalRight);
		silverButton:SetTextFontObject(NumberFontNormalRight);
		copperButton:SetTextFontObject(NumberFontNormalRight);
	end
