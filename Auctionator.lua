...
--		button:SetPoint("TOPRIGHT", "TradeSkillFrameCloseButton", "TOPLEFT", 0, -8);
		...
		button:SetHeight (16)
		button:SetText("AH")
		button:SetTextFontObject(_G["GameFontNormalSmall"])
...
function Atr_AuctionFrameTab_OnClick (a, b, index)
	...
	auctionator_orig_AuctionFrameTab_OnClick (a, b, index);
...
function Atr_SelectPane (whichTab)
	...
	Atr_AuctionFrameTab_OnClick (nil, nil, index);
...
function Atr_AddSellTab (tabtext, whichTab)
	...
	frame:SetTextFontObject(_G["AtrFontOrange"]);
...
function Atr_Duration_OnClick(self)
	...
	UIDropDownMenu_SetSelectedValue (Atr_Duration, this.value);
	Atr_SetDepositText();
end
...
function Atr_Dropdown_OnClick (info)
	...
	UIDropDownMenu_SetSelectedValue (Atr_ASDD_Subclass, this.value);
end
